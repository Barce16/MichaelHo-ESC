<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800">Customer Spending Report</h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-lg shadow-sm p-8">
                ...
                <div class="border-b-2 border-gray-300 pb-6 mb-6">
                    <div class="flex items-start justify-between">
                        ...
                        <div class="text-right">
                            <h2 class="text-xl font-bold text-gray-900">Customer Spending Report</h2>
                ...
                <div class="grid md:grid-cols-4 gap-6 mb-8">
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6 border-2 border-blue-200">
                        <div class="text-sm text-blue-700 font-medium mb-1">Total Customers</div>
                        <div class="text-4xl font-bold text-blue-900">{{ $stats['total_customers'] }}</div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6 border-2 border-purple-200">
                        <div class="text-sm text-purple-700 font-medium mb-1">Avg Per Customer</div>
                        <div class="text-3xl font-bold text-purple-900">₱{{ number_format($stats['avg_per_customer'], 2)
                            }}</div>
                    </div>

                    @if($stats['top_spender'])
                    <div class="bg-gradient-to-br from-orange-50 to-amber-50 rounded-lg p-6 border-2 border-orange-200">
                        <div class="text-sm text-orange-700 font-medium mb-1">Top Spender</div>
                        <div class="text-lg font-bold text-orange-900 truncate">{{ $stats['top_spender']->customer_name
                            }}</div>
                        <div class="text-sm text-orange-700">₱{{ number_format($stats['top_spender']->total_spent, 2) }}
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="py-8 text-center text-gray-500">No customer spending data in this
                                    period</td>
                            </tr>
                            @endforelse
                        </tbody>
