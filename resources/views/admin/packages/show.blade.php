    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h4 class="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                ...
                Package Banner
                <span class="ml-2 px-2 py-0.5 bg-blue-100 text-blue-700 text-xs font-semibold rounded">Portrait</span>
            </h4>

            <div class="flex justify-center">
                <div class="relative rounded-xl overflow-hidden shadow-lg border-2 border-gray-200 w-80 group">
                    <img src="{{ $package->banner_url }}" alt="{{ $package->name }} banner"
                        class="w-full h-[480px] object-cover group-hover:scale-105 transition-transform duration-300"
                        loading="lazy">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                        <p class="text-white font-bold text-lg">{{ $package->name }}</p>
                        <p class="text-white/90 text-xs">{{ $package->type }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h4 class="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <svg class="w-5 h-5 fill-gray-500" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet"
