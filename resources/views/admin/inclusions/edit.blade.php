<x-admin.layouts.management>
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-2xl font-bold text-gray-900">Edit Inclusion</h3>
                <p class="text-gray-500 mt-1">Update service details and information</p>
            </div>
            <a href="{{ route('admin.management.inclusions.show', $inclusion) }}"
        ...
        <form method="POST" action="{{ route('admin.management.inclusions.update', $inclusion) }}"
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', $inclusion->name) }}" required
                        ...
                        <div>
                            ...
                            <select name="category" id="category" required
                                ...
                                <option value="{{ $category->value }}" @selected(old('category', $inclusion->
                        ...
                        <div class="mb-4">
                            ...
                            <select name="package_type" id="package_type"
                                ...
                                <option value="{{ $type }}" {{ old('package_type', $inclusion->package_type) == $type ?
                                    'selected' : '' }}>
                                    {{ $type }}
                                </option>
                                @endforeach
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Current:
                                @if($inclusion->package_type)
                                <span class="font-medium text-indigo-600">{{ $inclusion->package_type }}</span>
                                @else
                                <span class="font-medium text-gray-500">Available for all packages</span>
                                @endif
                            </p>
                            @error('package_type')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" min="0" name="price"
                                    value="{{ old('price', $inclusion->price) }}"
                        ...
                        <div class="flex items-end">
                            <div
                                ...
                                <input id="is_active" name="is_active" type="checkbox" value="1"
                                    @checked(old('is_active', $inclusion->is_active))
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="p-6 space-y-4">
                    {{-- Current Image --}}
                    @if($inclusion->image)
                    <div id="currentImageWrapper" class="space-y-2">
                        ...
                        <div
                            ...
                            <img src="{{ asset('storage/' . $inclusion->image) }}" alt="{{ $inclusion->name }}"
                                id="currentImage" class="absolute inset-0 w-full h-full object-cover">
                        </div>
                    </div>
                    @endif
                    ...
                    <div id="imagePreviewContainer" class="hidden">
                        ...
                        <div
                            class="relative w-full max-w-md aspect-[4/3] overflow-hidden rounded-lg border-2 border-emerald-200">
