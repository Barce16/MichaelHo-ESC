                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('admin.events.schedules', $event) }}"
                                ...
                                Manage Schedules
                                @php
                                $scheduledCount = $event->schedules?->filter(fn($s) => $s->scheduled_date)->count() ??
                                0;
                                $totalInclusions = $event->inclusions->count();
                                @endphp
                                @if($scheduledCount > 0)
                                <span class="ml-1 px-2 py-0.5 text-xs bg-white/20 rounded-full">
                                    {{ $scheduledCount }}/{{ $totalInclusions }}
                                </span>
                                @endif
                            </a>
