                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-bold text-blue-900 mb-2">⏳ Downpayment Under Review</h3>
                                <p class="text-blue-800 mb-4">Your downpayment of ₱{{
                                    number_format($pendingDownpayment->amount, 2) }} is being verified. Your event will
                                    be
                                    scheduled once approved!</p>
                                <div class="text-xs text-blue-600">Submitted: {{
                                    $pendingDownpayment->created_at->diffForHumans() }}</div>
                            </div>
                        </div>
                    </div>
                </div>
