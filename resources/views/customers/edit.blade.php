            ...
            <div class="bg-white shadow-sm rounded-lg p-6">
                <form method="POST" action="{{ route('customers.update',$customer) }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-text-input name="customer_name" value="{{ old('customer_name',$customer->customer_name) }}"
                    ...
                    <div>
                        ...
                        <x-text-input name="phone" value="{{ old('phone',$customer->phone) }}" class="mt-1 w-full" />
                    ...
                    <div class="pt-2">
                        <button class="bg-gray-800 text-white px-4 py-2 rounded">Update</button>
