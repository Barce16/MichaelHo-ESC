<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            return $e->billing->payments()->where('status', 'pending')->count();
            });
            $completedBillings = $eventsWithBillings->filter(fn($e) => $e->billing &&
            $e->billing->isFullyPaid())->count();
            @endphp
            ...
            $outstandingAmount = $billing->remaining_balance ?? 0;
            ...
            $paymentHistory = $billing->payments()->orderBy('created_at', 'desc')->get();
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-4 border border-blue-200">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <div class="text-xs text-blue-700 font-semibold uppercase tracking-wide">Total Amount
                                </div>
                            </div>
                            <div class="text-2xl font-bold text-blue-900">₱{{ number_format($totalAmount, 2) }}</div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2 mb-2">
                                <svg class="w-4 h-4 {{ $isPaid ? 'text-gray-600' : 'text-rose-600' }}" fill="none"
